                    ...
                    <div className="container d-flex justify-content-between align-items-center">
                        ...
                        <div className="collapse navbar-collapse" id="navbarCollapse">
                            <div className="navbar-nav nav-center-width d-flex justify-content-between">
                                <Link href="#" onMouseDown={() => handleLinkClick("/")} className="nav-item nav-link list-style">
                                    Home
                                </Link>
                                {/* <!-- mobile view --> */}
                                <div
                                            ...
                                            <div className="col-lg-3 col-xl-3 nav-list-left">
                                                <ul className="list-unstyled mt-3 px-2">
                                                    <li className="mb-3">
                                                        <Link
                                                            href="#"
                                                            className="mb-2 mt-3 text-decoration-none nav-right-sub-heading"
                                                        >
                                                            Custom Web Development
                                                        </Link>
                                                    </li>
                                ...
                                <Link href="#" className="nav-item nav-link list-style">
                                    Case studies
                                </Link>
                                <Link
                                    href="#"
